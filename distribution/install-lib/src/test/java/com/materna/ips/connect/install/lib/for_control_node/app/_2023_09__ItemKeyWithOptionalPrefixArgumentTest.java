...
import com.materna.ips.connect.install.lib.for_control_node.cmdlets.GetCfgCmdlet;
...
/**
 * Test the new parameter "-optionalItemKeyPrefix" of the class
 * {@link GetCfgCmdlet}.
 *
 ...
 *
 */
public class _2023_09__ItemKeyWithOptionalPrefixArgumentTest extends ControlNodeAppTestBase {
    @Test
    public void testGetValuePos() {
        try (CmdletContextForTests ctx = UtilForTesting.createContext()) {
            ...
            // @formatter:off
            callCmd(ctx,
                    MainCfg.ARG_CFG_VALUE, "version=" + expectedOutput,
                    GetCfgCmdletFactory.CMD_NAME,
                    GetCfgCfg.ARG_CLUSTER_NAME, "blue",
                    GetCfgCfg.ARG_ITEM_KEY_OPTIONAL_PREFIX, "services",
                    GetCfgCfg.ARG_ITEM_KEY, "version"
                    );
            // @formatter:on
